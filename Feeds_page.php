            ...
            <div class="bottom_fix_nav_block">
                ...
                <div class="icon_fix bell_fix">
                    <a href="Notification-page.html" onclick="event.preventDefault(); setTimeout(function() { window.location.href = 'Notification-page.html'; }, 1000); this.classList.add('clicked');">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 548 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="icon_fix home_fix ">
                    <a href="Feeds_page.php" onclick="event.preventDefault(); setTimeout(function() { window.location.href = 'Feeds_page.php'; }, 1000); this.classList.add('clicked');">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 612"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="icon_fix mic_fix">
                    <a href="spaces.html" onclick="event.preventDefault(); setTimeout(function() { window.location.href = 'spaces.html'; }, 1000); this.classList.add('clicked');">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 518 999"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <div class="user_profile_content">
                        ...
                        <div class="add_post_edit_details_btn">
                            <div class="add_post_btn">
                                <button onclick="window.location.href='Create-post-page.html';"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                            ...
                                            <div class="_post_info">
                                                ...
                                                <div class="_info_bottom">
                                                    ...
                                                    <div class="_left_btn_s">
                                                        ...
                                                        <div class="_btn_s view_count">
                                                            <svg width="25" height="18" fill="gray" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                        ...
                                                        <div class="_btn_s _comment_count">
                                                            <svg width="25" height="18" fill="gray" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
...
=======
>>>>>>> ad056f9975a0035bda8ee94957ae9112665ca7d3
