...
?>
    ...
    <div class="signup_container">
        ...
        <div class="signup_container_tabs">
            ...
            <a href="#sign_in_page" class="signup_Tab_link sign_active">Sign in</a>

            <a href="#sign_up_page" class="signup_Tab_link">Sign Up</a>
        ...
        <div class="tabs_content_sign">
            ...
            <div id="sign_in_page" class="signup_tab_data sign_active">
                ...
                <p style="font-size: 16px; line-height: 23px; color: #ccc; width: 100%; max-width: 90%;margin-bottom: 10px;">
                    <a href="#"style="color: #56aaff;">Forgot Password?</a>
                </p>
 ...
 <!-- sign up page sec -->
            <div id="sign_up_page" class="signup_tab_data ">
                ...
                <input type="text" placeholder="Confirm Password">
                 ...
                 <p style="font-size: 16px; line-height: 23px; color: #ccc; width: 100%; max-width: 90%;">
                    <input style="width: fit-content;padding: 5px;" type="checkbox" name="" id="">
