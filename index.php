...
<head>
    ...
    <title>Blogging and Article Writing website.</title>
    ...
    <main class="_main_container">
        ...
        <div class="landing-page-container">
            ...
            <div class="landing-page-main-sec">
                ...
                <div class="landing-page-sec-one">
                    <h1 data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500"><span
                            style="color: hsl(34, 97%, 64%);">CREATE MIND,</span> CREATE WORKS</h1>
                    <h3 data-aos="fade-left" data-aos-easing="linear" data-aos-duration="1500">We Are Digital Agency
                    </h3>

                    <button onclick="window.location.href='signup.php';" data-aos-easing="linear"
                        data-aos-duration="1500" data-aos="fade-up">GETTING STARTED</button>
        ...
        <div class="featured-home-post-card-container">
            ...
            <div class="featured-home-post-card-main-sec">
                <div class="featured-home-post-card-sec-one">
                    <img src="static/images/mirehtisham-logo-zip-file/png/logo-no-background.png" alt="logo">
        ...
        <div class="homecard-sec-container">
            ...
            <div class="_posts_container">
                <div class="_posts">
                    ...
                    <div class="_post_card" data-aos-duration="3000" data-aos="fade-up">
                        <a class="_post_img" href="#">
                            <img src="https://cdn.pixabay.com/photo/2021/05/22/10/11/fishing-boat-6273132__340.jpg"
                                alt="">
                        </a>
                        ...
                        <div class="_post_info">
                            ...
                            <div class="_info_top">
                                ...
                                <div class="_info_top_left">
                                    <svg width="22" height="22" fill="white" class="bi bi-three-dots-vertical"
                                        viewBox="0 0 16 16">
                                        <path
                            ...
                            <div class="_info_bottom">
                                ...
                                <div class="_left_btn_s">
                                    ...
                                    <div class="_btn_s _comment_count">
                                        <svg width="25" height="18" fill="gray" class="bi bi-chat-square"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="_post_card" data-aos-duration="3000" data-aos="fade-up">
                        <a class="_post_img" href="#">
                            <img src="https://cdn.pixabay.com/photo/2022/01/23/19/40/northern-hawk-owl-6961772__340.jpg"
                                alt="">
                        </a>
                            ...
                            <div class="_info_top">
                                ...
                                <div class="_info_top_right">
                                    <div class="_profile_data">
                                        ...
                                        <div class="_user_profile">
                                            <img src="https://cdn.pixabay.com/photo/2014/10/06/17/30/child-476507__340.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="home_btn">
                    <button data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500"
                        onclick="window.location.href='Feeds_page.php';">Click Here</button>
                </div>
        ...
        <span>Mirehti</span>
            ...
            <div class="article_cards_main_section">
                ...
                <div class="tweet-wrap-container" data-aos="fade-left" data-aos-easing="linear"
                ...
                <div class="tweet-wrap-container" data-aos="fade-right" data-aos-easing="linear"
                    data-aos-duration="1500">
                    <div class="tweet-header">
                        <!-- <div class="date_artcile_card">
                ...
                <div class="home_btn">
                    <button data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500"
                        onclick="window.location.href='all-articles-page.html';">Click Here</button>
                </div>
        ...
        <div class="services-sec-container">
            ...
            <div class="services-sec-container-two-main">
                <div class="services-sec-container-two">
                    ...
                    <div class="serices-sec-card-one" data-aos="fade-down" data-aos-easing="linear"
                        data-aos-duration="1500">
                        <svg height="30" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path fill="#66FCF1"
                    ...
                    <div class="serices-sec-card-one" data-aos="fade-up" data-aos-easing="linear"
                        data-aos-duration="1500">
                        <svg height="30" xmlns="http://www.w3.org/2000/svg"
