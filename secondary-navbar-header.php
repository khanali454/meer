...
<head>
    ...
    <!-- ========== css-styling files ============= -->
       ...
       <link rel="stylesheet" href="static/css/User_Profile_page.css">
       <link rel="stylesheet" href="static/css/only_post_card.css">
    ...
    <div class="nav-logo-profile-search">
        ...
        <div class="search-profile-box" >
            ...
            <div class="secondary-profile" >
                <a href=""><img src="static/images/profile2.jpg" alt=""></a>
            </div>
          </div>
        </div>
             <!-- fix manue start -->
...
<div class="icon_fix mic_fix">
    ...
    <div class="user_profile_container" style="margin-bottom: 55px;" >
        ...
        <div class="_posts_container break_line_user_unfo">
            ...
            <div class="_posts">
                ...
                <div class="_post_card">
                    ...
                    <div class="_post_info">
                        <div class="_date_time" style="justify-content: space-around;">
