...
<body>
    ...
    <div class="_table_container_">
        <p style="padding:10px 0;color:rgba(255,255,255,0.46);">Showing <?= ($start==0)?1:$start ?> to <?= (($start + $limit)>$total_users)?($start + $limit)-1:($start + $limit)-1 ?> of <?= $total_users ?> users</p>
